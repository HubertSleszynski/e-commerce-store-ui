...
const Navbar = () => {
  ...
  return (
    <header className="max-w-screen-2xl xl:px-28 px-4 absolute top-0 left-0 right-0 m items-center justify-center mx-auto">
      <nav className="flex justify-between items-center container md:py-4 pt-6 pb-3">
        <a href="/" className="">
          <p className="text-3xl font-medium">HRS.</p>
        </a>
