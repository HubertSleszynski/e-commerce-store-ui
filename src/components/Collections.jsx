...
const Collections = () => {
  return (
    <div className='bg-[url("/assets/collection-bg.png")] bg-cover bg-center bg-no-repeat xl:px-28 px-4 my-20 max-sm:hidden'>
      <div className=" h-[580px]  flex justify-between flex-col md:flex-row items-center">
        <div className="md:w-1/2"></div>
        <div className="md:w-1/2">
          <img src="/assets/zara-logo.png" alt="" />
          <p className="text-lg text-white my-8 md:w-2/3 leading-[32px]">
